...
public class SamuraiMelee extends Character {
	...
	public SamuraiMelee(double x, double y) {
		...
		walkFrames = new Image[] { Assets.loadImage("samuraiMelee/RealKnight.png"),
				...
				Assets.loadImage("samuraiMelee/Walk04.png"), Assets.loadImage("samuraiMelee/Walk05.png"),
				Assets.loadImage("samuraiMelee/Walk06.png"), Assets.loadImage("samuraiMelee/Walk07.png"),
				Assets.loadImage("samuraiMelee/Walk08.png"), Assets.loadImage("samuraiMelee/Walk09.png") };

		dashFrames = new Image[] { Assets.loadImage("samuraiMelee/mlDash_1.png"),
				Assets.loadImage("samuraiMelee/mlDash_2.png"), Assets.loadImage("samuraiMelee/mlDash_3.png"),
				Assets.loadImage("samuraiMelee/mlDash_4.png") };

		jumpFrames = new Image[] { Assets.loadImage("samuraiMelee/Jump01.png"),
				Assets.loadImage("samuraiMelee/Jump02.png"), Assets.loadImage("samuraiMelee/Jump03.png"),
				Assets.loadImage("samuraiMelee/Jump04.png"), Assets.loadImage("samuraiMelee/Jump05.png") };

		attackFrames = new Image[] { Assets.loadImage("samuraiMelee/attack01.png"),
				Assets.loadImage("samuraiMelee/mlDash_4.png"), Assets.loadImage("samuraiMelee/attack05.png") };

		defendFrames = new Image[] { Assets.loadImage("samuraiMelee/defend01.png"),
