...
public class SkeletonWarrior extends Skeleton {
	...
	public SkeletonWarrior(double x, double y, Character player) {
		super(x, y, player);
		setCurrentHealth(GameConfig.SKELETON_WAR_MAX_HEALTH);

		walkFrames = new Image[] { Assets.loadImage("skeletonWarrior/skewRun_0.png"),
				Assets.loadImage("skeletonWarrior/skewRun_1.png"), Assets.loadImage("skeletonWarrior/skewRun_2.png"),
				Assets.loadImage("skeletonWarrior/skewRun_3.png"), Assets.loadImage("skeletonWarrior/skewRun_4.png"),
				Assets.loadImage("skeletonWarrior/skewRun_5.png"), Assets.loadImage("skeletonWarrior/skewRun_6.png"),
				Assets.loadImage("skeletonWarrior/skewRun_7.png"), };
		attackFrames = new Image[] { Assets.loadImage("skeletonWarrior/skewAttack_0.png"),
