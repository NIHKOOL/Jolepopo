...
public class SamuraiArcher extends Character {
    ...
    public SamuraiArcher(double x, double y) {
        ...
        walkFrames = new Image[] {
            ...
            Assets.loadImage("samuraiArcher/arWalk_2.png"), 
            Assets.loadImage("samuraiArcher/arWalk_3.png"),
            Assets.loadImage("samuraiArcher/arWalk_4.png"), 
            Assets.loadImage("samuraiArcher/arWalk_5.png"), 
            Assets.loadImage("samuraiArcher/arWalk_6.png"),
            Assets.loadImage("samuraiArcher/arWalk_7.png"), 
            Assets.loadImage("samuraiArcher/arWalk_8.png")
        };

        dashFrames = new Image[] {
            Assets.loadImage("samuraiArcher/arDash_1.png"), 
            Assets.loadImage("samuraiArcher/arDash_2.png"),
            Assets.loadImage("samuraiArcher/arDash_3.png"), 
            Assets.loadImage("samuraiArcher/arDash_4.png")
        };

        jumpFrames = new Image[] {
            Assets.loadImage("samuraiArcher/arJump_1.png"), 
            Assets.loadImage("samuraiArcher/arJump_2.png"), 
            Assets.loadImage("samuraiArcher/arJump_3.png"),
            Assets.loadImage("samuraiArcher/arJump_4.png"), 
            Assets.loadImage("samuraiArcher/arJump_5.png"),
            Assets.loadImage("samuraiArcher/arJump_6.png"), 
            Assets.loadImage("samuraiArcher/arJump_7.png")
        };

        attackFrames = new Image[] {
            Assets.loadImage("samuraiArcher/arShoot_0.png"), 
            Assets.loadImage("samuraiArcher/arShoot_1.png"), 
            Assets.loadImage("samuraiArcher/arShoot_2.png"),
            Assets.loadImage("samuraiArcher/arShoot_3.png"), 
            Assets.loadImage("samuraiArcher/arShoot_4.png"), 
            Assets.loadImage("samuraiArcher/arShoot_5.png"),
            Assets.loadImage("samuraiArcher/arShoot_6.png"), 
            Assets.loadImage("samuraiArcher/arShoot_7.png"), 
            Assets.loadImage("samuraiArcher/arShoot_8.png"),
            Assets.loadImage("samuraiArcher/arShoot_9.png"), 
            Assets.loadImage("samuraiArcher/arShoot_10.png"), 
            Assets.loadImage("samuraiArcher/arShoot_11.png"),
            Assets.loadImage("samuraiArcher/arShoot_12.png"), 
